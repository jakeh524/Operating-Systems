...
int main(int argc, char * argv[]) {
    ...
    list = (SortedList_t*)malloc(list_elements_num*sizeof(SortedList_t));
    int i;
    ...
    {
        int thread_error = pthread_create(&thread_array[thread_iter], NULL, &list_thread_func, NULL);
        if(thread_error != 0)
        {
    ...
    long long total_time = (end_time.tv_sec - start_time.tv_sec)*1000000 + (end_time.tv_nsec - start_time.tv_nsec); //idk if this is how to calculate time
    ...
    if(sync_option == 'x')
    {
        ...
        {
            fprintf(stdout, "list-none-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "i") == 0)
        {
            fprintf(stdout, "list-i-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "d") == 0)
        {
            fprintf(stdout, "list-d-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "l") == 0)
        {
            fprintf(stdout, "list-l-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "id") == 0) || (strcmp(yield_option, "di") == 0))
        {
            fprintf(stdout, "list-id-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "il") == 0) || (strcmp(yield_option, "li") == 0))
        {
            fprintf(stdout, "list-il-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "dl") == 0) || (strcmp(yield_option, "ld") == 0))
        {
            fprintf(stdout, "list-dl-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        ...
        {
            fprintf(stdout, "list-idl-none,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
    }
    ...
    else if(sync_option == 'm')
    {
        if(strcmp(yield_option, "x") == 0) // no yield
        {
            fprintf(stdout, "list-none-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "i") == 0)
        {
            fprintf(stdout, "list-i-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "d") == 0)
        {
            fprintf(stdout, "list-d-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "l") == 0)
        {
            fprintf(stdout, "list-l-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "id") == 0) || (strcmp(yield_option, "di") == 0))
        {
            fprintf(stdout, "list-id-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "il") == 0) || (strcmp(yield_option, "li") == 0))
        {
            fprintf(stdout, "list-il-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "dl") == 0) || (strcmp(yield_option, "ld") == 0))
        {
            fprintf(stdout, "list-dl-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "idl") == 0) || (strcmp(yield_option, "ild") == 0) || (strcmp(yield_option, "lid") == 0) || (strcmp(yield_option, "ldi") == 0) || (strcmp(yield_option, "dil") == 0) || (strcmp(yield_option, "dli") == 0))
        {
            fprintf(stdout, "list-idl-m,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
    }
    ...
    else if(sync_option == 's')
    {
        if(strcmp(yield_option, "x") == 0) // no yield
        {
            fprintf(stdout, "list-none-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "i") == 0)
        {
            fprintf(stdout, "list-i-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "d") == 0)
        {
            fprintf(stdout, "list-d-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if(strcmp(yield_option, "l") == 0)
        {
            fprintf(stdout, "list-l-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "id") == 0) || (strcmp(yield_option, "di") == 0))
        {
            fprintf(stdout, "list-id-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "il") == 0) || (strcmp(yield_option, "li") == 0))
        {
            fprintf(stdout, "list-il-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "dl") == 0) || (strcmp(yield_option, "ld") == 0))
        {
            fprintf(stdout, "list-dl-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
        else if((strcmp(yield_option, "idl") == 0) || (strcmp(yield_option, "ild") == 0) || (strcmp(yield_option, "lid") == 0) || (strcmp(yield_option, "ldi") == 0) || (strcmp(yield_option, "dil") == 0) || (strcmp(yield_option, "dli") == 0))
        {
            fprintf(stdout, "list-idl-s,%d,%d,%d,%d,%lld,%lld\n", threads_num, iterations_num, 1, total_operations, total_time, average_operation_time);
        }
    }
...
void* list_thread_func(__attribute__((unused)) void* arg) {
    if(sync_option == 'x')
    {
        int start = thread_iter * iterations_num;
        int i;
        for(i = start; i < (start + iterations_num); i++)
        {
...
void segfault_handler(int signal)
{
    fprintf(stderr, "Segmentation Fault detected. %i\n", signal);
    exit(2);
}
